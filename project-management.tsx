...
const servicesSubLinks = [
  ...
  { name: 'Approval for Construction', href: 'construction-approval.html', icon: 'fas fa-stamp', description: 'Navigating regulatory landscapes to secure all necessary construction permits and approvals efficiently.', image: 'https://images.unsplash.com/photo-1563291074-2bf8677ac0e5?w=800&auto=format&fit=crop&q=60' }
];
